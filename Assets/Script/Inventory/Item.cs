...
public class Item
{
    ...
    public bool ContainController(ControllersEnum controller)
    {
        return controller switch
        {
            ControllersEnum.InspectItem => IsInspect,
            ControllersEnum.EquipItem => IsEquip,
            ControllersEnum.UseItem => IsUse,
            ControllersEnum.DropItem =>IsDrop,
            ControllersEnum.OpenItem => IsOpen,
            _ => false
        };
...
public class OpenItem
{
    ...
    {
        InventoryControler.Instance.OpenInventory(item.Name, item.Id, Width, Heigth);
    }
